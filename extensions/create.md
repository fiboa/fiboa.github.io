...
* Add your extension to the list above if needed.
  ...
  You can add external/community extensions to the list above by editing the [config file](https://github.com/fiboa/fiboa.github.io/edit/main/extensions/external-extensions.yaml) and creating a PR from it.
